    ...
    <div class="col-md-12">
                ...
                <div class="title-container">     <!-- Чтобы background-color не цеплял padding -->
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <h2 class="title-text">Примеры наших работ</h2>
                        </div>
                    </div>
                </div>
        ...
        <div class="row text-center">
            <div class="col-md-12 col-md-offset-0">
                <h2 class="color-red"><a href="<<?php echo URL;?>contacts">
                        Свяжитесь с нами</a> и мы поможем вам в выборе качественного и недорогого окна !
                </h2>
            </div>
        </div>
    </div>
